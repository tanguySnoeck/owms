...
=======
            deployType = grunt.option('deployType'),
            folderIn = grunt.option('in'),
            folderOut = grunt.option('out');

        if (deployType === 'gd.com') {
            grunt.task.run('compress:gamedistribution');
            return;
        }
...
=======
        var published = grunt.config.get('game.published');
        var gameDescription = grunt.config.get('game.description');
        var soon = grunt.option('comingSoon');
        var update = new Date().toString();
>>>>>>> origin/multi
